...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 12 Oca 2021, 20:31:36
...
--
CREATE DATABASE IF NOT EXISTS `meteozcan_final` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `meteozcan_final`;
...
CREATE TABLE `kitap` (
  ...
  `YayinEviKayitNo` int(10) NOT NULL COMMENT 'YayınEvi Numarası',
  `YazarKayitNo` int(11) NOT NULL COMMENT 'Yazar Numarası'
...
INSERT INTO `kitap` (`KitapKayitNo`, `KitapKayitTarih`, `KitapAdi`, `KitapISBN`, `KitapBasimYeri`, `KitapBasimTarih`, `KitapDili`, `KitapSayfaSayisi`, `YayinEviKayitNo`, `YazarKayitNo`) VALUES
...
CREATE TABLE `yayinevi` (
  `YayinEviKayitNo` smallint(6) NOT NULL COMMENT 'Yayın Evi Kayıt No',
  `YayinEviKayitTarihi` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Yayın Evinin Veri Tabanına Kayıt Edildiği Tarih',
...
INSERT INTO `yayinevi` (`YayinEviKayitNo`, `YayinEviKayitTarihi`, `YayinEviAdi`, `YayinEviURL`, `YayinEviEPosta`) VALUES
(1, '2020-11-02 18:27:52', 'Siren Yayınları', 'https://sirenyayinlari.com', 'info@sirenyayinlari.com'),
(2, '2020-11-02 18:52:48', 'Yitik Ülke Yayınları', 'https://www.yitikulkeyayinlari.com', 'yitikulke@gmail.com'),
...
CREATE TABLE `yazar` (
  `YazarKayitNo` smallint(6) NOT NULL COMMENT 'Yazarın Kayıt Numarası',
  `YazarKayitTarihi` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Yazarın Veritabanına Kayıt Edildiği Tarih',
...
(4, '2020-11-02 19:18:52', 'İmam', 'Gazali', 'https://www.kitapyurdu.com/yazar/imam-gazali/20955.html'),
...
--
ALTER TABLE `kitap`
  MODIFY `KitapKayitNo` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'Kitap Tablosunun Ana Anahtarı', AUTO_INCREMENT=47;

--
-- Tablo için AUTO_INCREMENT değeri `yayinevi`
--
ALTER TABLE `yayinevi`
  MODIFY `YayinEviKayitNo` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'Yayın Evi Kayıt No', AUTO_INCREMENT=24;

--
-- Tablo için AUTO_INCREMENT değeri `yazar`
--
ALTER TABLE `yazar`
  MODIFY `YazarKayitNo` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'Yazarın Kayıt Numarası', AUTO_INCREMENT=29;
COMMIT;
