<?php
    ...
    $sorgu = "UPDATE yayinevi SET YayinEviAdi = '$YayinEviAdi', YayinEviURL = '$YayinEviURL', YayinEviEPosta = '$YayinEviEPosta' WHERE YayinEviKayitNo = $YayinEviKayitNo";
...
echo("<table border=1>");
    ...
    echo("<td><b>Yayinevi EPosta</b></td>");
