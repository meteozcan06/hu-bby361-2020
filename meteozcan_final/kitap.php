...
$sorgu = mysqli_query($baglanti, 
   "SELECT K.KitapKayitNo, K.KitapKayitTarih, K.KitapAdi, K.KitapISBN, K.KitapBasimYeri, K.KitapBasimTarih, K.KitapDili, K.KitapSayfaSayisi, CONCAT(R.YazarAdi,' ', R.YazarSoyadi) AS AdSoyad, Y.YayinEviAdi
   FROM kitap K, yazar R, yayinevi Y 
   WHERE K.YayinEviKayitNo = Y.YayinEviKayitNo AND 
            K.YazarKayitNo = R.YazarKayitNo ");
?>
  ...
  <h1>Kitap Listesi</h1>
        ...
        <?php
            ...
            while($satir = mysqli_fetch_assoc($sorgu)){
                ...
                echo("<td><a href='kitapguncellenecek.php?KitapKayitNo=".$satir["KitapKayitNo"]."'>Güncelle</a></td>");
