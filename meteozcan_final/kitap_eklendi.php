<?php
    ...
    $sorgu = "INSERT INTO kitap (KitapAdi, KitapISBN, KitapBasimYeri, KitapBasimTarih, KitapDili, KitapSayfaSayisi, YazarKayitNo, YayinEviKayitNo)
            VALUES ('$KitapAdi', '$KitapISBN', '$KitapBasimYeri', '$KitapBasimTarih', '$KitapDili', '$KitapSayfaSayisi', '$YazarKayitNo', '$YayinEviKayitNo')";
