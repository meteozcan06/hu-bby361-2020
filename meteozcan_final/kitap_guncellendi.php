<?php
    ...
    $sorgu = "UPDATE kitap SET KitapAdi = '$KitapAdi', KitapISBN = '$KitapISBN', KitapBasimYeri = '$KitapBasimYeri', KitapBasimTarih = '$KitapBasimTarih', KitapDili = '$KitapDili', KitapSayfaSayisi = '$KitapSayfaSayisi', YazarKayitNo = '$YazarKayitNo', YayinEviKayitNo = '$YayinEviKayitNo' WHERE KitapKayitNo = $KitapKayitNo";
